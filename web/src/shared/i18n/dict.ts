...
export const RU: Dict = {
  ...
  "connectMarzban.client.happ_note": "Основной клиент Shpun. Самый простой вариант: установили, вернулись сюда и добавили подписку.",
  "connectMarzban.client.v2ray_note": "Альтернативный вариант, если Happ не подходит или уже установлен v2RayTun.",
  "connectMarzban.client.hiddify_note": "Запасной клиент для тех, кому удобнее Hiddify.",
...
export const EN: Dict = {
  ...
  "connectMarzban.client.happ_note": "Main Shpun client. The simplest option: install it, come back here, and add the subscription.",
  "connectMarzban.client.v2ray_note": "Alternative option if Happ is not suitable or v2RayTun is already installed.",
  "connectMarzban.client.hiddify_note": "Backup client for users who prefer Hiddify.",
