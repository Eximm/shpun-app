...
export const RU: Dict = {
  ...
  "connectFlexPlus.ready_desc": "Flex Plus готов. Это дополнительная подписка для мобильных сетей и сложных подключений.",
...
export const EN: Dict = {
  ...
  "connectFlexPlus.ready_desc": "Flex Plus is ready. This is an extra subscription for mobile networks and difficult connections.",
