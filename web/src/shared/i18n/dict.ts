...
export const RU: Dict = {
  ...
  "router.widget_servers.title": "Смена сервера — в виджете роутера",
  "router.widget_servers.desc": "В приложении оставили привязку и статус. Локацию и протокол теперь меняйте прямо в виджете роутера: он ближе к железу и меньше делает вид, что ему надо подумать.",
...
export const EN: Dict = {
  ...
  "router.widget_servers.title": "Server switching is in the router widget",
  "router.widget_servers.desc": "The app now keeps binding and status only. Change location and protocol directly in the router widget: it is closer to the hardware and has fewer reasons to pretend it needs a moment.",
