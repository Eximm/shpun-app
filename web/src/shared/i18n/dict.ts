...
export const RU: Dict = {
  ...
  "connect.import_text": "Ссылка подписки скопирована. Если импорт не открылся сам, вставьте её в клиент вручную.",
  ...
  "connectMarzban.happ.import_text": "Happ должен открыться и принять подписку. Ссылка также скопирована на всякий случай.",
  ...
  "connectMarzban.v2ray.import_text": "v2RayTun должен открыться и принять подписку. На всякий случай ссылка уже скопирована.",
...
export const EN: Dict = {
  ...
  "connect.import_text": "The subscription link was copied. If import does not open automatically, paste it into the client manually.",
  ...
  "connectMarzban.happ.import_text": "Happ should open and accept the subscription. The link is also copied just in case.",
  ...
  "connectMarzban.v2ray.import_text": "v2RayTun should open and accept the subscription. The link is copied just in case.",
