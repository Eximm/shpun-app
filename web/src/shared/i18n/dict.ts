...
export const RU: Dict = {
  ...
  "connect.sub_ready_desc": "Подписка на месте. Осталось добавить её в клиент, совсем без шаманства.",
  ...
  "connect.import_text": "v2RayTun должен открыться и принять подписку. Почти культурно.",
  ...
  "connectMarzban.mirror.sub": "Если основной импорт делает вид, что не знаком с вами, попробуйте RU-зеркало.",
  "connectMarzban.mirror.cta": "Подключить через RU-зеркало",
  "connectMarzban.mirror.short": "RU зеркало",
  "connectMarzban.routing.title": "Раздельная маршрутизация",
  "connectMarzban.routing.sub": "Только РФ-трафик напрямую, остальное — в туннель",
  "connectMarzban.routing.apply": "Применить маршруты",
  "connectMarzban.routing.qr": "QR-код",
  "connectMarzban.routing.manual_title": "Откройте v2RayTun вручную",
  "connectMarzban.routing.manual_desc": "Перейдите в Настройки → Правила маршрутизации. Да, руками, но недолго.",
  "connectMarzban.routing.opening_title": "⚡ Применяем маршруты",
  "connectMarzban.routing.opening_desc": "Открываем v2RayTun и передаём ему маршруты. Пусть работает.",
  "connectMarzban.routing.modal_title": "Маршруты v2RayTun",
  "connectMarzban.routing.modal_sub": "Отсканируйте QR в v2RayTun, чтобы раздать трафику роли без лишней драмы.",
  "connectMarzban.routing.qr_alt": "QR маршрутов",
  "connectMarzban.extra.sub": "QR, копирование подписки и запасной клиент, потому что один путь — это скучно.",
  "connectMarzban.hiddify.alt_client": "альтернативный клиент",
  "connectMarzban.hiddify.to_hiddify": "в Hiddify",
  "connectMarzban.hiddify.import_text": "Hiddify должен открыться и принять подписку. Вежливо, по возможности.",
  ...
  "connect.qr_text": "Откройте v2RayTun на другом устройстве и импортируйте подписку через QR. Камера сегодня работает.",
  ...
  "connect.step_import_desc": "После установки вернитесь сюда и добавьте подписку в v2RayTun. Само, увы, пока не нажмётся.",
...
export const EN: Dict = {
  ...
  "connect.sub_ready_desc": "Subscription is in place. Add it to the client; no rituals required.",
  ...
  "connect.import_text": "v2RayTun should open and accept the subscription. Almost politely.",
  ...
  "connectMarzban.mirror.sub": "If the main import pretends it does not know you, try the RU mirror.",
  "connectMarzban.mirror.cta": "Connect via RU mirror",
  "connectMarzban.mirror.short": "RU mirror",
  "connectMarzban.routing.title": "Split routing",
  "connectMarzban.routing.sub": "Only RU traffic goes directly; everything else goes through the tunnel",
  "connectMarzban.routing.apply": "Apply routes",
  "connectMarzban.routing.qr": "QR code",
  "connectMarzban.routing.manual_title": "Open v2RayTun manually",
  "connectMarzban.routing.manual_desc": "Go to Settings → Routing rules. Manually, yes, but briefly.",
  "connectMarzban.routing.opening_title": "⚡ Applying routes",
  "connectMarzban.routing.opening_desc": "Opening v2RayTun and handing it the routes. Let it work.",
  "connectMarzban.routing.modal_title": "v2RayTun routes",
  "connectMarzban.routing.modal_sub": "Scan the QR in v2RayTun to give traffic its roles without extra drama.",
  "connectMarzban.routing.qr_alt": "Routes QR",
  "connectMarzban.extra.sub": "QR, subscription copy, and a backup client, because one path is boring.",
  "connectMarzban.hiddify.alt_client": "alternative client",
  "connectMarzban.hiddify.to_hiddify": "to Hiddify",
  "connectMarzban.hiddify.import_text": "Hiddify should open and accept the subscription. Politely, ideally.",
  "connect.copy_link": "Copy link",
  "connect.copied": "Link copied",
  "connect.show_qr": "Show QR",
  "connect.qr_title": "Subscription QR code",
  "connect.qr_text": "Open v2RayTun on another device and import the subscription via QR. The camera gets a job today.",
  ...
  "connect.step_import_desc": "After installation, come back here and add the subscription in v2RayTun. It will not click itself, sadly.",
