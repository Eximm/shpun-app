...
export const RU: Dict = {
  ...
  "servicesOrder.error.unpaid_order.title": "Есть активный или неоплаченный заказ",
    ...
    "servicesOrder.error.trial_email.title": "Почте нужен короткий кивок",
    "servicesOrder.error.trial_email.desc": "Тестовый ключ почти ваш. Сначала подтвердим почту, чтобы тесты не разбегались по чужим рукам.",
...
export const EN: Dict = {
  ...
  "servicesOrder.error.unpaid_order.title": "There is an active or unpaid order",
    ...
    "servicesOrder.error.trial_email.title": "Email needs a quick nod",
    "servicesOrder.error.trial_email.desc": "Your trial key is almost ready. Please verify your email first, so trials stay in the right hands.",
