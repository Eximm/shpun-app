...
export const RU: Dict = {
  ...
  "connectMarzban.happ.import_text": "Happ должен открыться и добавить подписку. На всякий случай ссылка уже скопирована.",
...
export const EN: Dict = {
  ...
  "connectMarzban.happ.import_text": "Happ should open and add the subscription. The link is copied just in case.",
