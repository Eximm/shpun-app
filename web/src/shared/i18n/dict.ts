...
export const RU: Dict = {
  ...
  "pwa.onboarding.install.prompt.text": "Откроется отдельно, без браузерной рамки.",
  ...
  "pwa.onboarding.push.text": "Напомним про оплату, баланс и услуги. Без рекламного шума.",
...
export const EN: Dict = {
  ...
  "pwa.onboarding.install.prompt.text": "Opens separately, without the browser frame.",
  ...
  "pwa.onboarding.push.text": "Payments, balance, and services. No promo noise.",
