...
export const RU: Dict = {
  ...
  "connectMarzban.client.happ_note": "Рекомендуем Happ: установите приложение, вернитесь сюда и добавьте подписку.",
...
export const EN: Dict = {
  ...
  "connectMarzban.client.happ_note": "Recommended: install Happ, come back here, and add the subscription.",
