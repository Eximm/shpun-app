...
export const RU: Dict = {
  ...
  "connectMarzban.client.happ_note": "Лучший вариант для Shpun: Happ поддерживает встроенные маршруты и проще всего принимает подписку.",
...
export const EN: Dict = {
  ...
  "connectMarzban.client.happ_note": "Best option for Shpun: Happ has built-in routing and imports the subscription most smoothly.",
