...
export const RU: Dict = {
  ...
  "connectMarzban.happ.add_cta": "Скопировать и открыть Happ",
  "connectMarzban.happ.import_text": "Ссылка скопирована. Если Happ открылся, нажмите «+» и вставьте её как подписку.",
...
export const EN: Dict = {
  ...
  "connectMarzban.happ.add_cta": "Copy and open Happ",
  "connectMarzban.happ.import_text": "The link is copied. If Happ opens, tap “+” and paste it as a subscription.",
