...
export const RU: Dict = {
  ...
  "profile.pwa.guide.ios.text": "На iPhone приложение ставится только через Safari. В Telegram или стороннем браузере сначала откройте страницу в Safari.",
  ...
  "profile.pwa.guide.android.text": "В Chrome обычно появляется системная установка. Если кнопки нет, используйте меню браузера.",
  ...
  "profile.pwa.guide.windows.text": "В Chrome или Edge приложение устанавливается как отдельное окно и появляется в меню «Пуск».",
  ...
  "profile.pwa.guide.desktop.text": "Если браузер поддерживает PWA, установка доступна через меню или адресную строку.",
  ...
  "pwa.onboarding.install.prompt.text": "Добавим Shpun App на устройство? Будет открываться как отдельное приложение: быстрее, чище и без лишней браузерной рамки.",
  "pwa.onboarding.install.ios.title": "Добавить на экран?",
  "pwa.onboarding.install.ios.text": "iPhone немного упрямится: установка делается через Safari и кнопку «Поделиться». Сейчас покажем короткий маршрут.",
  "pwa.onboarding.install.ios.steps": "1) Откройте страницу в Safari\n2) Нажмите «Поделиться»\n3) Выберите «На экран Домой»\n4) Подтвердите добавление",
  "pwa.onboarding.install.android.title": "Добавить приложение?",
  "pwa.onboarding.install.android.text": "Android обычно умеет поставить Shpun App в пару нажатий. Если системное окно не появилось, идём через меню браузера.",
  "pwa.onboarding.install.android.steps": "1) Откройте страницу в Chrome\n2) Нажмите меню ⋮\n3) Выберите «Установить приложение» или «Добавить на главный экран»\n4) Подтвердите установку",
  "pwa.onboarding.install.windows.title": "Поставить на Windows?",
  "pwa.onboarding.install.windows.text": "Shpun App откроется отдельным окном и поселится в меню «Пуск». Почти взрослое приложение, только без лишней установки.",
  "pwa.onboarding.install.windows.steps": "1) Откройте страницу в Chrome или Edge\n2) Нажмите значок установки в адресной строке или меню ⋮\n3) Выберите «Установить Shpun App»\n4) Подтвердите установку",
  "pwa.onboarding.install.desktop.title": "Добавить приложение?",
  "pwa.onboarding.install.desktop.text": "Если браузер поддерживает установку, Shpun App можно открыть отдельным аккуратным окном. Без вкладок, хаоса и охоты за адресной строкой.",
  ...
  "pwa.onboarding.install.accepted.text": "После установки откройте Shpun App и включите уведомления.",
  "pwa.onboarding.install.dismissed.title": "Окей, не тащим за рукав",
  "pwa.onboarding.install.dismissed.text": "Вернёмся к установке позже. Профиль всё помнит, даже когда мы делаем вид, что нет.",
  "pwa.onboarding.push.title": "Включим важные сигналы?",
  "pwa.onboarding.push.text": "Напомним про оплату, баланс и услуги. Без рекламного шума, только когда правда есть повод.",
  ...
  "pwa.onboarding.push.guide.text": "Системное окно не открылось или браузер сделал вид, что он главный. Покажем, где включить вручную.",
...
export const EN: Dict = {
  ...
  "profile.pwa.guide.ios.text": "On iPhone, the app can be installed only through Safari. If you are in Telegram or another browser, open the page in Safari first.",
  "profile.pwa.guide.ios.steps": "1) Open the app in Safari\n2) Tap Share\n3) Choose Add to Home Screen\n4) Confirm",
  "profile.pwa.guide.android.title": "Install on Android",
  "profile.pwa.guide.android.text": "Chrome usually shows a system install prompt. If there is no button, use the browser menu.",
  "profile.pwa.guide.android.steps": "1) Open the page in Chrome\n2) Tap the ⋮ menu\n3) Choose Install app or Add to Home Screen\n4) Confirm",
  "profile.pwa.guide.windows.title": "Install on Windows",
  "profile.pwa.guide.windows.text": "In Chrome or Edge, the app installs as a separate window and appears in the Start menu.",
  ...
  "profile.pwa.guide.desktop.text": "If your browser supports PWA, installation is available through the menu or address bar.",
  "profile.pwa.guide.desktop.steps": "1) Open the page in Chrome, Edge, or Safari\n2) Find Install app or Add to Home Screen\n3) Confirm",
  "pwa.onboarding.install.prompt.text": "Add Shpun App to this device? It opens like a real app: faster, cleaner, and without the browser frame hanging around.",
  "pwa.onboarding.install.ios.title": "Add to Home Screen?",
  "pwa.onboarding.install.ios.text": "iPhone is a little picky: install works through Safari and the Share button. Here is the short route.",
  "pwa.onboarding.install.ios.steps": "1) Open the page in Safari\n2) Tap Share\n3) Choose Add to Home Screen\n4) Confirm",
  "pwa.onboarding.install.android.title": "Add the app?",
  "pwa.onboarding.install.android.text": "Android usually installs Shpun App in a couple of taps. If the system prompt did not appear, use the browser menu.",
  "pwa.onboarding.install.android.steps": "1) Open the page in Chrome\n2) Tap the ⋮ menu\n3) Choose Install app or Add to Home Screen\n4) Confirm",
  "pwa.onboarding.install.windows.title": "Install on Windows?",
  "pwa.onboarding.install.windows.text": "Shpun App will open in its own window and live in the Start menu. Almost suspiciously convenient.",
  "pwa.onboarding.install.windows.steps": "1) Open the page in Chrome or Edge\n2) Click the install icon in the address bar or open the ⋮ menu\n3) Choose Install Shpun App\n4) Confirm",
  "pwa.onboarding.install.desktop.title": "Add the app?",
  "pwa.onboarding.install.desktop.text": "If your browser supports installation, Shpun App can open in a clean separate window. No tab hunting required.",
  ...
  "pwa.onboarding.install.accepted.text": "After installation, open Shpun App and enable notifications.",
  "pwa.onboarding.install.dismissed.title": "All right, no sleeve-pulling",
  "pwa.onboarding.install.dismissed.text": "We can come back to installation later. Profile remembers things, annoyingly well.",
  "pwa.onboarding.push.title": "Enable useful signals?",
  "pwa.onboarding.push.text": "We will remind you about payments, balance, and services. No promo noise, only when there is a real reason.",
  ...
  "pwa.onboarding.push.guide.text": "The system prompt did not open or the browser decided to be important. Here is where to enable it manually.",
  ...
  "servicesRouter.quick_start.step_2": "Install shpun-router_1.0.0_all.ipk",
