...
export const RU: Dict = {
  ...
  "connectMarzban.mirror.sub": "Используйте RU-зеркало, если основной импорт не открылся.",
  ...
  "connectMarzban.routing.manual_desc": "Перейдите в Настройки → Правила маршрутизации",
  "connectMarzban.routing.opening_title": "⚡ Применяем маршруты",
  "connectMarzban.routing.opening_desc": "Открываем v2RayTun…",
  "connectMarzban.routing.modal_title": "Маршруты v2RayTun",
  "connectMarzban.routing.modal_sub": "Отсканируйте QR в v2RayTun для настройки раздельной маршрутизации.",
  "connectMarzban.routing.qr_alt": "QR маршрутов",
  "connectMarzban.extra.sub": "QR, копирование подписки и альтернативный клиент.",
...
export const EN: Dict = {
  ...
  "connectMarzban.mirror.sub": "Use the RU mirror if the main import did not open.",
  ...
  "connectMarzban.routing.manual_desc": "Go to Settings → Routing rules",
  "connectMarzban.routing.opening_title": "⚡ Applying routes",
  "connectMarzban.routing.opening_desc": "Opening v2RayTun…",
  "connectMarzban.routing.modal_title": "v2RayTun routes",
  "connectMarzban.routing.modal_sub": "Scan the QR in v2RayTun to set up split routing.",
  "connectMarzban.routing.qr_alt": "Routes QR",
  "connectMarzban.extra.sub": "QR, subscription copy, and an alternative client.",
