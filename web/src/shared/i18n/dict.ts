...
export const RU: Dict = {
  ...
  "login.err.telegram_auth_limited": "Telegram-вход временно притормозил. Подождите минуту и попробуйте снова.",
...
export const EN: Dict = {
  ...
  "login.tg.subtitle": "Passwordless inside Telegram",
  ...
  "login.tg.step.cabinet": "Opening dashboard",
  "login.tg.fallback.note": "Sign-in usually starts by itself. If Telegram did not pass the data, tap the button once.",
  ...
  "login.err.telegram_auth_limited": "Telegram sign-in is temporarily slowed down. Wait a minute and try again.",
