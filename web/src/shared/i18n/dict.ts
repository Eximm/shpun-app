...
export const RU: Dict = {
  ...
  "referralNudge.toast.title.1": "Ага, попался",
  "referralNudge.toast.title.2": "Рефералка выглянула",
  ...
  "referralNudge.toast.title.6": "Бонус делает вид, что случайный",
  "referralNudge.toast.desc.1": "Можно отправить реферальную ссылку другу. Мы никого не заставляем, просто стоим рядом с табличкой.",
  "referralNudge.toast.desc.2": "Если друг всё ещё без нормального доступа, кажется, у нас тут совпадение.",
  "referralNudge.toast.desc.3": "Реферальная ссылка лежит спокойно, но явно хочет на прогулку.",
  "referralNudge.toast.desc.4": "Один клик — и можно потом делать вид, что бонус сам пришёл.",
  "referralNudge.toast.desc.5": "Проверка связи: друзья есть, ссылка есть, интрига есть.",
  "referralNudge.toast.desc.6": "Система шепчет: поделиться ссылкой — это почти забота. Почти.",
  "referralNudge.toast.desc.7": "Рефералка не шумит, она просто аккуратно машет рукой из угла.",
  "referralNudge.toast.desc.8": "Кто-то может получить доступ, а вы — бонус. Подозрительно удобно.",
  "referralNudge.toast.action.1": "Попался",
  "referralNudge.toast.action.2": "Открыть ссылку",
  "referralNudge.toast.action.3": "Показать",
...
export const EN: Dict = {
  ...
  "referralNudge.toast.title.1": "Aha, caught you",
  "referralNudge.toast.title.2": "Referral link peeked out",
  ...
  "referralNudge.toast.title.6": "The bonus is acting casual",
  "referralNudge.toast.desc.1": "You can send your referral link to a friend. No pressure, just a tiny signpost.",
  "referralNudge.toast.desc.2": "If a friend still needs decent access, this looks suspiciously convenient.",
  "referralNudge.toast.desc.3": "The referral link is sitting quietly, but it clearly wants a walk.",
  "referralNudge.toast.desc.4": "One click, and later you can pretend the bonus arrived by itself.",
  "referralNudge.toast.desc.5": "Quick check: friends exist, link exists, intrigue exists.",
  "referralNudge.toast.desc.6": "The system whispers: sharing a link is almost caring. Almost.",
  "referralNudge.toast.desc.7": "The referral system is not being loud. It is just waving carefully from the corner.",
  "referralNudge.toast.desc.8": "Someone gets access, you get a bonus. Suspiciously useful.",
  "referralNudge.toast.action.1": "Caught",
  "referralNudge.toast.action.2": "Open link",
  "referralNudge.toast.action.3": "Show me",
