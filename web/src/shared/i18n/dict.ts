...
export const RU: Dict = {
  ...
  "connectMarzban.fallback.routing_title": "Открываем маршрутизацию",
  "connectMarzban.fallback.routing_desc": "Если Happ не открылся автоматически, нажмите кнопку ещё раз или скопируйте ссылку маршрутизации.",
...
export const EN: Dict = {
  ...
  "connectMarzban.fallback.routing_title": "Opening routing",
  "connectMarzban.fallback.routing_desc": "If Happ did not open automatically, tap the button again or copy the routing link.",
